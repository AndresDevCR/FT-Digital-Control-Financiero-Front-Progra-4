...
function Details() {
  ...
  const fetchEmployee = async () => {
    try {
      const response = await axios.get(`https://control-financiero.herokuapp.com/api/v1/human-rescourse/${id}`, {
        headers: {
  ...
  return (
    <>
      <Head>
        <title>Detalles del Empleado | FT Control Financiero</title>
      </Head>
            ...
            <Grid container spacing={2}>
              <Grid item xs={12} md={6}>
                <Typography variant="subtitle1">
                  Nombre del empleado: {employee.employee_name}
                </Typography>
              </Grid>
              <Grid item xs={12} md={6}>
                <Typography variant="subtitle1">
              ...
              <Grid item xs={12} md={6}>
                <Typography variant="subtitle1">
                  Fecha de entrada: {formatDate(employee.entry_date)}
                </Typography>
              </Grid>
              <Grid item xs={12} md={6}>
                <Typography variant="subtitle1">
              ...
              <Grid item xs={12} md={6}>
                <Typography variant="subtitle1">
                  Días de descanso: {employee.rest_days}
                </Typography>
              </Grid>
              <Grid item xs={12} md={6}>
                <Typography variant="subtitle1">
                  Días de vacaciones: {employee.vacation_days}
                </Typography>
              </Grid>
            </Grid>
          </CardContent>

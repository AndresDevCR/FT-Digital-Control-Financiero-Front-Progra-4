...
MenuShow.getLayout = (page) => <DashboardLayout>{page}</DashboardLayout>;
...
export default function MenuShow() {
  ...
  return (
    <RoleBasedGuard roles={['administrator', 'user']} hasContent>
      <Head>
        <title>Control Financiero | Menu</title>
      </Head>
      ...
      >
        ...
        <Typography sx={{ color: 'text.secondary' }}>
          Bienvenido al tablero de navegación de Control Financiero
        </Typography>

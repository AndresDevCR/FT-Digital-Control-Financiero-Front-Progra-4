        ...
        <Card sx={{ marginTop: '2rem' }}>
          <CardContent>
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} md={6}>
                <Typography variant="subtitle1">
                  Nombre del empleado: {product.employee_name}
                </Typography>
              </Grid>
              <Grid item xs={12} md={6}>
                <Typography variant="subtitle1">
                  Cantidad disponible: {product.available_quantity}
                </Typography>
              </Grid>
              <Grid item xs={12} md={6}>
                <Typography variant="subtitle1">
                  Fecha de inicio: {formatDate(product.start_date)}
                </Typography>
              </Grid>
              <Grid item xs={12} md={6}>
                <Typography variant="subtitle1">
                  Fecha de reingreso: {formatDate(product.reentry_date)}
                </Typography>
              </Grid>
              <Grid item xs={12} md={6}>
                <Typography variant="subtitle1">
                  Estado de la solicitud: {product.request_status}
                </Typography>
              </Grid>
            </Grid>
          </CardContent>
